...
**데모:** https://Park11234.github.io/uc-table/ &nbsp;·&nbsp; **오프라인 설치:** 데모 접속 → 브라우저 메뉴 → 홈 화면에 추가
...
> 궤양성 대장염 환자로써 평소 음식을 먹을 때 불편했던 부분을 개인 경험을 참고하여 해결할 수 있는 수단을 생각
> 설계·구현·검토에 AI 도구(Claude)를 활용, 규칙과 근거 자료는 원문을 확인해 확정
> 주변인들에게 어플을 소개해서 사용자 경험을 물어보고 AI를 활용하여 개선
